...
_STRINGS: Dict[str, Dict[str, str]] = {
    ...
    'en': {
        ...
        'btn_shuffle_both': 'Вопросы и ответы',
        ...
        'manual_first_question': 'Отправьте вопрос 1.\n- Можно написать текст\n- Или отправить изображение (подпись будет использована как текст вопроса)',
...
_FINAL_CLEAN_EXTRA: Dict[str, Dict[str, str]] = {'de': {'premium_choose_plan': 'Bitte wahlen Sie einen Premium-Tarif:'},
 'tr': {'premium_choose_plan': 'Lutfen bir Premium plan secin:',
        'upload_hint': 'Bir dosya gönderin (.pdf / .docx / .pptx / .xlsx / .txt).\nPDF/PPTX için sayfa aralığı seçimi zorunludur.',
        'choose_time': 'Her soru için süreyi seçin:',
        'count_chosen': 'Soru sayısı: {n}.',
        'shuffle_prompt_ai': 'Karıştırma türünü seçin:',
...
_FINAL_RUNTIME_FIXES: Dict[str, Dict[str, str]] = {
    "uz": {
        ...
        "more_quizzes_available": "Yana testlar bor.",
        "btn_more_quizzes": "Qolgan testlarni ko'rish",
        "previous_result": "📌 Oldingi natijangiz:\n✅ {correct_label}: {correct}/{total}\n📝 {answered_label}: {answered}\n⏱ {total_time_label}: {time}s",
        "btn_start_this_quiz": "Bu testni boshlash",
        "btn_start_group_quiz": "Guruhda testni boshlash",
        "btn_share_quiz": "Testni ulashish",
        "btn_edit_questions": "Savollarni tahrirlash",
        "btn_edit_answers": "Javoblarni tahrirlash",
        "edit_questions_choose_question": "Savolni tahrirlash: savol raqamini tanlang ({count} ta).",
        "edit_question_prompt": "Hozirgi savol:\n{question}\n\nYangi savol matnini yuboring:",
        "edit_question_required": "Savol matnini yuboring.",
        "edit_question_updated": "Savol saqlandi.",
        "edit_answers_prompt": "Hozirgi savol va javoblar:\n{question}\n\n4 ta javob variantini yuboring, har biri yangi qatorda:",
        "edit_answers_need_4_lines": "Iltimos, aynan 4 ta javob variantini yuboring (4 qator).",
        "edit_answers_choose_question": "Javoblarni tahrirlash: savol raqamini tanlang ({count} ta).",
        "edit_answers_choose_correct": "To'g'ri javob raqamini tanlang:",
        "edit_answers_updated": "Javoblar saqlandi.",
        "menu_help": "Menyudagi bo'limlar:\n- Fayl yuklash: fayl yoki elektron kitob yuklash orqali test tuzishingiz mumkin.\n- Mavzu bo'yicha test: mavzuni yozib, qiyinlik, son va vaqtni tanlab test tuzishingiz mumkin.\n- Yangi test: savollarni qo'lda kiritib test tuzishingiz mumkin.\n- Interfeys tili: botning interfeys tilini o'zgartirishingiz mumkin.\n- Premium: limitlarni oshirish va premium olish bo'limi.\n- Bonuslar: referral bonusi bo'limi.",
        "bonuses_menu_text": "Bonuslar bo'limi.\n- Referral bonusi: havolangiz orqali do'st taklif qiling.",
        "channel_bonus_disabled": "Kanal bonusi o'chirilgan.",
        "share_card_ready": "Ulashish uchun test kartasi tayyor.",
        "share_inline_hint": "Ulashish uchun yangilangan tugmani bosing va yuboriladigan chatni tanlang. Eski xabarda boshlash ishlamasa, test kartasini qayta ulashing.",
        "inline_share_title": "{title}",
        "inline_share_description": "Savollar: {count} ta | Har savol: {sec}s | ID: {id}",
        "open_bot_to_start": "Testni boshlash uchun bot ochiladi.",
        "upload_mode_prompt": "Fayl yuklash turini tanlang:",
        "btn_upload_structured": "Strukturalangan fayl (bepul)",
        "btn_upload_ai": "AI bilan test tuzish",
        "btn_view_sample_file": "Namuna faylini ko'rish",
        "upload_hint_structured": "Strukturalangan test faylini yuboring (.pdf / .docx / .txt).\nBu bo'lim AI ishlatmaydi va bepul.\nFaylda tayyor savollar bo'lishi kerak: savol + 4 ta variant + to'g'ri javob.",
        "structured_file_parsed": "Fayldan {n} ta tayyor savol topildi.",
        "structured_quiz_ready": "Test tayyor!\n\nTest: {title}\nSavollar: {count} ta\nHar savol: {sec}s (taxminan {est})\nID: {id}\n\nBoshlash uchun `Testni boshlash` tugmasini bosing.",
    },
    "ru": {
        "btn_back": "Назад",
        ...
        "more_quizzes_available": "Есть еще тесты.",
        "btn_more_quizzes": "Посмотреть остальные тесты",
        "previous_result": "📌 Ваш предыдущий результат:\n✅ {correct_label}: {correct}/{total}\n📝 {answered_label}: {answered}\n⏱ {total_time_label}: {time}s",
        "btn_start_this_quiz": "Начать этот тест",
        "btn_start_group_quiz": "Начать тест в группе",
        "btn_share_quiz": "Поделиться тестом",
        "btn_edit_questions": "Редактировать вопросы",
        "btn_edit_answers": "Редактировать ответы",
        "edit_questions_choose_question": "Редактирование вопроса: выберите номер вопроса ({count}).",
        "edit_question_prompt": "Текущий вопрос:\n{question}\n\nОтправьте новый текст вопроса:",
        "edit_question_required": "Отправьте текст вопроса.",
        "edit_question_updated": "Вопрос сохранён.",
        "edit_answers_prompt": "Текущий вопрос и ответы:\n{question}\n\nОтправьте 4 варианта ответа, каждый с новой строки:",
        "edit_answers_need_4_lines": "Пожалуйста, отправьте ровно 4 варианта ответа (4 строки).",
        ...
        "edit_answers_updated": "Ответы сохранены.",
        "menu_help": "Разделы меню:\n- Загрузить файл: загрузите файл или электронную книгу, чтобы создать тест.\n- Тест по теме: введите тему, выберите сложность, количество и время.\n- Новый тест: создайте тест вручную.\n- Язык интерфейса: измените язык кнопок и сообщений бота.\n- Премиум: увеличьте лимиты и получите премиум.\n- Бонусы: реферальный бонус.",
        "bonuses_menu_text": "Раздел бонусов.\n- Реферальный бонус: приглашайте друзей по своей ссылке.",
        "channel_bonus_disabled": "Бонус за канал отключен.",
        "share_card_ready": "Карточка теста для отправки готова.",
        "share_inline_hint": "Нажмите обновленную кнопку отправки и выберите чат. Если запуск в старом сообщении не работает, отправьте карточку теста заново.",
        "inline_share_title": "{title}",
        "inline_share_description": "Вопросов: {count} | На вопрос: {sec}s | ID: {id}",
        "open_bot_to_start": "Бот откроется для запуска теста.",
        "upload_mode_prompt": "Выберите тип загрузки файла:",
        "btn_upload_structured": "Структурированный файл (бесплатно)",
        "btn_upload_ai": "Создать тест с AI",
        "btn_view_sample_file": "Посмотреть пример файла",
        "upload_hint_structured": "Отправьте структурированный файл теста (.pdf / .docx / .txt).\nЭтот раздел не использует AI и работает бесплатно.\nВ файле должны быть готовые вопросы: вопрос + 4 варианта + правильный ответ.",
        "structured_file_parsed": "В файле найдено готовых вопросов: {n}.",
        "structured_quiz_ready": "Тест готов!\n\nТест: {title}\nВопросов: {count}\nНа вопрос: {sec}s (примерно {est})\nID: {id}\n\nНажмите `Начать тест`, чтобы запустить.",
    },
    "en": {
        "btn_back": "Back",
        ...
        "more_quizzes_available": "More quizzes are available.",
        "btn_more_quizzes": "View remaining quizzes",
        "previous_result": "📌 Your previous result:\n✅ {correct_label}: {correct}/{total}\n📝 {answered_label}: {answered}\n⏱ {total_time_label}: {time}s",
        "btn_start_this_quiz": "Start this quiz",
        "btn_start_group_quiz": "Start quiz in group",
        "btn_share_quiz": "Share quiz",
        "btn_edit_questions": "Edit questions",
        "btn_edit_answers": "Edit answers",
        "edit_questions_choose_question": "Edit questions: choose a question number ({count}).",
        "edit_question_prompt": "Current question:\n{question}\n\nSend the new question text:",
        "edit_question_required": "Send the question text.",
        "edit_question_updated": "Question saved.",
        "edit_answers_prompt": "Current question and answers:\n{question}\n\nSend 4 answer options, each on a new line:",
        "edit_answers_need_4_lines": "Please send exactly 4 answer options (4 lines).",
        "edit_answers_choose_question": "Edit answers: choose a question number ({count}).",
        "edit_answers_choose_correct": "Choose the correct answer number:",
        "edit_answers_updated": "Answers saved.",
        "menu_help": "Menu sections:\n- Upload file: send a file or an e-book and the bot will create a quiz.\n- Quiz by topic: type a topic, choose difficulty/count/time and get a quiz.\n- New quiz: create a quiz manually by adding questions and options.\n- Interface language: change the language of buttons and messages.\n- Premium: increase limits and manage premium access.\n- Bonuses: referral bonus.",
        "bonuses_menu_text": "Bonuses section.\n- Referral bonus: invite friends with your referral link.",
        "channel_bonus_disabled": "Channel bonus is disabled.",
        "share_card_ready": "The shareable quiz card is ready.",
        "share_inline_hint": "Tap the updated share button and choose the chat. If start does not work in an old message, share the quiz card again.",
        "inline_share_title": "{title}",
        "inline_share_description": "Questions: {count} | Per question: {sec}s | ID: {id}",
        "open_bot_to_start": "The bot will open to start the quiz.",
        "upload_mode_prompt": "Choose the file upload type:",
        "btn_upload_structured": "Structured file (free)",
        "btn_upload_ai": "Create with AI",
        "btn_view_sample_file": "View sample file",
        "upload_hint_structured": "Send a structured quiz file (.pdf / .docx / .txt).\nThis section does not use AI and is free.\nThe file must contain ready questions: question + 4 options + correct answer.",
        "structured_file_parsed": "Found {n} ready questions in the file.",
        "structured_quiz_ready": "Quiz ready!\n\nQuiz: {title}\nQuestions: {count}\nPer question: {sec}s (about {est})\nID: {id}\n\nTap `Start quiz` to begin.",
    },
    "de": {
        "btn_back": "Zuruck",
        "btn_stats": "📊 Statistik",
        ...
        "more_quizzes_available": "Es gibt weitere Tests.",
        "btn_more_quizzes": "Weitere Tests anzeigen",
        "previous_result": "📌 Ihr vorheriges Ergebnis:\n✅ {correct_label}: {correct}/{total}\n📝 {answered_label}: {answered}\n⏱ {total_time_label}: {time}s",
        "btn_start_this_quiz": "Diesen Test starten",
        "btn_start_group_quiz": "Test in Gruppe starten",
        "btn_share_quiz": "Test teilen",
        "btn_edit_questions": "Fragen bearbeiten",
        "btn_edit_answers": "Antworten bearbeiten",
        "edit_questions_choose_question": "Frage bearbeiten: Wahlen Sie eine Fragennummer ({count}).",
        "edit_question_prompt": "Aktuelle Frage:\n{question}\n\nSenden Sie den neuen Fragetext:",
        "edit_question_required": "Senden Sie den Fragetext.",
        "edit_question_updated": "Frage gespeichert.",
        "edit_answers_prompt": "Aktuelle Frage und Antworten:\n{question}\n\nSenden Sie 4 Antwortoptionen, jede in einer neuen Zeile:",
        "edit_answers_need_4_lines": "Bitte senden Sie genau 4 Antwortoptionen (4 Zeilen).",
        "edit_answers_choose_question": "Antworten bearbeiten: Wahlen Sie eine Fragennummer ({count}).",
        "edit_answers_choose_correct": "Wahlen Sie die Nummer der richtigen Antwort:",
        "edit_answers_updated": "Antworten gespeichert.",
        "menu_help": "Menubereiche:\n- Datei hochladen: Laden Sie eine Datei oder ein E-Book hoch, um einen Test zu erstellen.\n- Test nach Thema: Geben Sie ein Thema ein und wahlen Sie Schwierigkeit, Anzahl und Zeit.\n- Neuer Test: Erstellen Sie einen Test manuell.\n- Oberflachensprache: Andern Sie die Sprache der Bot-Oberflache.\n- Premium: Erhohen Sie die Limits und erhalten Sie Premium.\n- Boni: Empfehlungsbonus.",
        "bonuses_menu_text": "Bonusbereich.\n- Empfehlungsbonus: Laden Sie Freunde uber Ihren Link ein.",
        "channel_bonus_disabled": "Der Kanalbonus ist deaktiviert.",
        "share_card_ready": "Die teilbare Testkarte ist bereit.",
        "share_inline_hint": "Tippen Sie auf die aktualisierte Teilen-Schaltflaeche und waehlen Sie den Chat.",
        "inline_share_title": "{title}",
        "inline_share_description": "Fragen: {count} | Pro Frage: {sec}s | ID: {id}",
        "open_bot_to_start": "Der Bot wird zum Starten des Tests geoeffnet.",
    },
    "tr": {
        "btn_back": "Geri",
        ...
        "more_quizzes_available": "Daha fazla test var.",
        "btn_more_quizzes": "Kalan testleri gor",
        "previous_result": "📌 Onceki sonucunuz:\n✅ {correct_label}: {correct}/{total}\n📝 {answered_label}: {answered}\n⏱ {total_time_label}: {time}s",
        "btn_start_this_quiz": "Bu testi baslat",
        "btn_start_group_quiz": "Testi grupta baslat",
        "btn_share_quiz": "Testi paylas",
        "btn_edit_questions": "Sorulari duzenle",
        "btn_edit_answers": "Cevaplari duzenle",
        "edit_questions_choose_question": "Soruyu duzenle: soru numarasini secin ({count}).",
        "edit_question_prompt": "Mevcut soru:\n{question}\n\nYeni soru metnini gonderin:",
        "edit_question_required": "Soru metnini gonderin.",
        "edit_question_updated": "Soru kaydedildi.",
        "edit_answers_prompt": "Mevcut soru ve cevaplar:\n{question}\n\n4 cevap secenegini gonderin, her biri yeni satirda:",
        "edit_answers_need_4_lines": "Lutfen tam olarak 4 cevap secenegi gonderin (4 satir).",
        "edit_answers_choose_question": "Cevaplari duzenle: soru numarasini secin ({count}).",
        "edit_answers_choose_correct": "Dogru cevap numarasini secin:",
        "edit_answers_updated": "Cevaplar kaydedildi.",
        "menu_help": "Menu bolumleri:\n- Dosya yukle: test olusturmak icin dosya veya e-kitap gonderebilirsiniz.\n- Konuya gore test: konu yazip zorluk, adet ve sure secerek test olusturabilirsiniz.\n- Yeni test: sorulari elle girerek test olusturabilirsiniz.\n- Arayuz dili: botun arayuz dilini degistirebilirsiniz.\n- Premium: limitleri artirip premium alabilirsiniz.\n- Bonuslar: referans bonusu.",
        "bonuses_menu_text": "Bonuslar bolumu.\n- Referans bonusu: arkadaslarinizi baglantinizla davet edin.",
        "channel_bonus_disabled": "Kanal bonusu devre disi.",
        "share_card_ready": "Paylasilabilir test karti hazir.",
        "share_inline_hint": "Guncel paylas dugmesine basin ve sohbeti secin.",
        "inline_share_title": "{title}",
        "inline_share_description": "Sorular: {count} | Soru basina: {sec}s | ID: {id}",
        "open_bot_to_start": "Testi baslatmak icin bot acilir.",
    },
    "kk": {
        "btn_back": "Artqa",
        "btn_stats": "📊 Statistika",
        ...
        "more_quizzes_available": "Tagy testter bar.",
        "btn_more_quizzes": "Qalgan testterdi koru",
        "previous_result": "📌 Aldyngy natizheniz:\n✅ {correct_label}: {correct}/{total}\n📝 {answered_label}: {answered}\n⏱ {total_time_label}: {time}s",
        "btn_start_this_quiz": "Bul testti bastau",
        "btn_start_group_quiz": "Testti topta bastau",
        "btn_share_quiz": "Testti bolisu",
        "btn_edit_questions": "Suraqtardy ozgertu",
        "btn_edit_answers": "Zhauaptardy ozgertu",
        "edit_questions_choose_question": "Suraqty ozgertu: suraq nomirin tandanyz ({count}).",
        "edit_question_prompt": "Qazirgi suraq:\n{question}\n\nZhana suraq matin in zhiberiniz:",
        "edit_question_required": "Suraq matinin zhiberiniz.",
        "edit_question_updated": "Suraq saqtaldy.",
        "edit_answers_prompt": "Qazirgi suraq zhane zhauaptar:\n{question}\n\n4 zhauap nusqasyn zhiberiniz, arqaisy zhana qatarda:",
        "edit_answers_need_4_lines": "Dal 4 zhauap nusqasyn zhiberiniz (4 qatar).",
        "edit_answers_choose_question": "Zhauaptardy ozgertu: suraq nomirin tandanyz ({count}).",
        "edit_answers_choose_correct": "Durys zhauap nomirin tandanyz:",
        "edit_answers_updated": "Zhauaptar saqtaldy.",
        "menu_help": "Menu bolimderi:\n- Fail zhykteu: test quru ushin fail nemese elektron kitaptı zhyktei alasiz.\n- Taqyryp boiynsha test: taqyrypty jazyp, kurdelilik, san zhane uaqytty tandap test qurasiz.\n- Zhana test: suraqtardy qoldan kirgizip test qurasiz.\n- Interfeis tili: bot interfeisinin tilin ozgerte alasiz.\n- Premium: limitterdi artirip, premium ala alasiz.\n- Bonustar: referral bonusy.",
        "bonuses_menu_text": "Bonus bolimi.\n- Referral bonusy: siltemeniz arqyly dostarynyzdy shaqyrynyz.",
        "channel_bonus_disabled": "Kanal bonusy oshirildi.",
        "share_card_ready": "Bolisu ushin test kartasy daiyr.",
        "share_inline_hint": "Zhanartylgan bolisu tuimesin basyp, chatty tandanyz.",
        "inline_share_title": "{title}",
        "inline_share_description": "Suraqtar: {count} | Ar suraq: {sec}s | ID: {id}",
        "open_bot_to_start": "Testti bastau ushin bot ashylady.",
    },
    "ar": {
        "btn_back": "رجوع",
        "btn_stats": "📊 الإحصاءات",
        ...
        "more_quizzes_available": "توجد اختبارات أخرى.",
        "btn_more_quizzes": "عرض الاختبارات المتبقية",
        "previous_result": "📌 نتيجتك السابقة:\n✅ {correct_label}: {correct}/{total}\n📝 {answered_label}: {answered}\n⏱ {total_time_label}: {time}s",
        "btn_start_this_quiz": "بدء هذا الاختبار",
        "btn_start_group_quiz": "بدء الاختبار في مجموعة",
        "btn_share_quiz": "مشاركة الاختبار",
        "btn_edit_questions": "تعديل الأسئلة",
        "btn_edit_answers": "تعديل الإجابات",
        "edit_questions_choose_question": "تعديل السؤال: اختر رقم السؤال ({count}).",
        "edit_question_prompt": "السؤال الحالي:\n{question}\n\nأرسل نص السؤال الجديد:",
        "edit_question_required": "أرسل نص السؤال.",
        "edit_question_updated": "تم حفظ السؤال.",
        "edit_answers_prompt": "السؤال والإجابات الحالية:\n{question}\n\nأرسل 4 خيارات إجابة، كل خيار في سطر جديد:",
        "edit_answers_need_4_lines": "يرجى إرسال 4 خيارات إجابة بالضبط (4 أسطر).",
        "edit_answers_choose_question": "تعديل الإجابات: اختر رقم السؤال ({count}).",
        "edit_answers_choose_correct": "اختر رقم الإجابة الصحيحة:",
        "edit_answers_updated": "تم حفظ الإجابات.",
        "bonuses_menu_text": "قسم المكافآت.\n- مكافأة الإحالة: ادعُ أصدقاءك عبر رابط الإحالة الخاص بك.",
        "channel_bonus_disabled": "تم تعطيل مكافأة القناة.",
        "share_card_ready": "بطاقة الاختبار للمشاركة جاهزة.",
        "share_inline_hint": "اضغط زر المشاركة المحدّث واختر المحادثة.",
        "inline_share_title": "{title}",
        "inline_share_description": "الأسئلة: {count} | لكل سؤال: {sec}s | ID: {id}",
        "open_bot_to_start": "سيتم فتح البوت لبدء الاختبار.",
    },
    "zh": {
        "btn_back": "返回",
        "btn_stats": "📊 统计",
        ...
        "more_quizzes_available": "还有更多测验。",
        "btn_more_quizzes": "查看剩余测验",
        "previous_result": "📌 您上次的结果：\n✅ {correct_label}: {correct}/{total}\n📝 {answered_label}: {answered}\n⏱ {total_time_label}: {time}s",
        "btn_start_this_quiz": "开始此测验",
        "btn_start_group_quiz": "在群组中开始测验",
        "btn_share_quiz": "分享测验",
        "btn_edit_questions": "编辑题目",
        "btn_edit_answers": "编辑答案",
        "edit_questions_choose_question": "编辑题目：请选择题号（{count}）。",
        "edit_question_prompt": "当前题目：\n{question}\n\n请发送新的题目文本：",
        "edit_question_required": "请发送题目文本。",
        "edit_question_updated": "题目已保存。",
        "edit_answers_prompt": "当前题目和答案：\n{question}\n\n请发送 4 个答案选项，每行一个：",
        "edit_answers_need_4_lines": "请准确发送 4 个答案选项（4 行）。",
        "edit_answers_choose_question": "编辑答案：请选择题号（{count}）。",
        "edit_answers_choose_correct": "请选择正确答案编号：",
        "edit_answers_updated": "答案已保存。",
        "bonuses_menu_text": "奖励栏目。\n- 邀请奖励：通过你的邀请链接邀请朋友。",
        "channel_bonus_disabled": "频道奖励已禁用。",
        "share_card_ready": "可分享的测验卡片已准备好。",
        "share_inline_hint": "点击更新后的分享按钮并选择聊天。",
        "inline_share_title": "{title}",
        "inline_share_description": "题目数：{count} | 每题：{sec}s | ID：{id}",
        "open_bot_to_start": "将打开机器人以开始测验。",
    },
    "ko": {
        "btn_back": "뒤로",
        "btn_stats": "📊 통계",
        ...
        "more_quizzes_available": "추가 퀴즈가 있습니다.",
        "btn_more_quizzes": "남은 퀴즈 보기",
        "previous_result": "📌 이전 결과:\n✅ {correct_label}: {correct}/{total}\n📝 {answered_label}: {answered}\n⏱ {total_time_label}: {time}s",
        "btn_start_this_quiz": "이 퀴즈 시작",
        "btn_start_group_quiz": "그룹에서 퀴즈 시작",
        "btn_share_quiz": "퀴즈 공유",
        "btn_edit_questions": "문항 편집",
        "btn_edit_answers": "답변 편집",
        "edit_questions_choose_question": "문항 편집: 문항 번호를 선택하세요({count}).",
        "edit_question_prompt": "현재 문항:\n{question}\n\n새 문항 텍스트를 보내세요:",
        "edit_question_required": "문항 텍스트를 보내세요.",
        "edit_question_updated": "문항이 저장되었습니다.",
        "edit_answers_prompt": "현재 문항과 답변:\n{question}\n\n답변 선택지 4개를 한 줄에 하나씩 보내세요:",
        "edit_answers_need_4_lines": "답변 선택지 4개를 정확히 보내세요(4줄).",
        "edit_answers_choose_question": "답변 편집: 문항 번호를 선택하세요({count}).",
        "edit_answers_choose_correct": "정답 번호를 선택하세요:",
        "edit_answers_updated": "답변이 저장되었습니다.",
        "bonuses_menu_text": "보너스 섹션입니다.\n- 추천 보너스: 추천 링크로 친구를 초대하세요.",
        "channel_bonus_disabled": "채널 보너스가 비활성화되었습니다.",
        "share_card_ready": "공유할 퀴즈 카드가 준비되었습니다.",
        "share_inline_hint": "업데이트된 공유 버튼을 누르고 채팅을 선택하세요.",
        "inline_share_title": "{title}",
        "inline_share_description": "문항 수: {count} | 문항당: {sec}s | ID: {id}",
        "open_bot_to_start": "퀴즈를 시작하기 위해 봇이 열립니다.",
    },
}
